...
int main()   
{
    ...
    cout << "\n";
    cout << "La position du premier separateur est " << esp[0] << endl;
    cout << "La position du deuxieme separateur est " << esp[1] << endl;
    cout << "La position du dernier separateur est " << esp[2] << endl;
