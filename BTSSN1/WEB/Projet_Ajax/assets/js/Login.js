function SignIn() {
    ...
    if (verifMail == true && verifPass == true ) {
        ...
        var form = "email=" + mail.value + "&password=" + password.value+ "&method=SignIn"; //On envoi les donnée des input au php
...
console.log(form);
        ...
        var form= "email="+mail.value+"&password="+password.value+"&password2="+password2.value+"&method="+method; //On envoi les donnée des input au php
...
function initialisation(choix) {
    ...
    if (choix == 1) {
        ...
        var latlng = new google.maps.LatLng(48.86075335917802, 2.338617480811113);
        var options = {
            center: latlng,
            zoom: 12,
        };
